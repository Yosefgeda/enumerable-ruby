...
**[enumerable-ruby]** A program to make the all? any? anf filter enumerables 
...
```sh
  cd my-folder
  git clone https://github.com/yosefgeda/enumerable-ruby.git
```
...
Feel free to check the [issues page](https://github.com/yosefgeda/enumerable-ruby/issues).
